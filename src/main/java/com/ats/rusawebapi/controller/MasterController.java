...
public class MasterController {
	...
	@RequestMapping(value = { "/getAllCatIdBySectionIdAndLangIdOrderByDesc" }, method = RequestMethod.POST)
	public @ResponseBody List<GetCategory> getAllCatIdBySectionIdAndLangIdOrderByDesc(@RequestParam("sectionId") int sectionId,
			@RequestParam("langId") int landId) {

		List<GetCategory> catList1 = null;

		try {

			catList1 = getGetCategoryRepo.getAllCatIdBySectionIdAndLangIdOrderByDesc(sectionId,landId);
