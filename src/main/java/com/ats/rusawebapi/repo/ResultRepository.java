...
public interface ResultRepository extends JpaRepository<Result, Integer>{
	...
	@Query(value="SELECT ev.newsblogs_id as id,'event-info' as class, unix_timestamp(ev.event_date_from) as start , unix_timestamp(ev.event_date_from) as end , ed.heading as title ,'#' as url       FROM `t_newsblogs` ev\n" + 
