...
public interface EventDetailRepo extends JpaRepository<EventDetail, Integer> {
	...
	@Query(value = "select e.* ,r.name,nd.heading,r.mobile_number,r.user_type "
	...
	@Query(value = " select e.* ,r.name,nd.heading,r.mobile_number,r.user_type from t_registration r,event_registration e, t_newsblogs_description nd,t_newsblogs n \n" + 
